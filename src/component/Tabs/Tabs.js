                ...
                <div className='container'>
                    <div id="tab-1-content" className={`tab-content-item ${activeTabName === CANCEL_AT_ANY_TIME && "show"}`}>
                        <div className='tab-1-content-inner'>
                            <div>
                                <p className='text-lg'>
                                    If you decide Netflix isn't for you - np problem. No Commitment. Cancel online anytime
                                </p>
                ...
                <div className='container'>
                    <div id="tab-3-content" className={`tab-content-item ${activeTabName === PICK_YOUR_PRICE && "show"}`}>
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>Monthly price after free month ends on 5/06/2022</td>
                                    <td>₱369.00</td>
                                    <td>₱459.00</td>
                                    <td>₱549.00</td>
                                </tr>
